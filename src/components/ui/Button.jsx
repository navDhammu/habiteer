...
const VARIANTS = {
	...
	secondary:
		'border text-indigo-500 border-indigo-500 active:bg-indigo-200 hover:bg-indigo-500 hover:text-white active:bg-indigo-500 disabled:text-gray-300 disabled:border-gray-300 disabled:bg-gray-50',
	'secondary-danger':
