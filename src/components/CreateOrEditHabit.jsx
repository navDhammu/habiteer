				...
				<DrawerBody>
					<Box
						...
						<VStack spacing='4' align='start'>
							<Heading size='sm'>
								1. Choose habit name and category
							</Heading>
						...
						<VStack spacing='4' align='start' mt='4'>
							<Heading size='sm'>
								2. Create habit repeat schedule
							</Heading>
							<FormControl
								isInvalid={errors.trackingStartDate != null}>
							...
							<FormControl
								as='fieldset'
								isInvalid={errors.repeatDays != null}>
								<FormLabel as='legend'>
									Habit repeat schedule
								</FormLabel>
								<Wrap spacing='4'>
									{formData.repeatDays.map(
										({ id, name, checked }) => (
											<WrapItem>
												<Checkbox
													id={id}
